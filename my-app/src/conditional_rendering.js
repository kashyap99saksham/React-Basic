...
// We cannot use any condition inside jsx [inside JSX we can only use Expression]
...
// We are using two file name as [user_conditional.js] and [Guest_conditional.js]
...
// We are creating A file which is for Amazon prime memeber ... if member is prime then then file run else print normal user
